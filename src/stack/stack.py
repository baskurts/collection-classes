...
class stack:
    ...
    def getData(self):
        ...
        i = 1                   # used to count the nodes in the calling stacks
    ...
    def push(self, element):
        ...
        # get the number of nodes in the callign stack 
    ...
    def isEmpty(self):
        ...
        Returns:
            Boolena: True if the calling stack is empty, else False.
        """        
        return self.size() == 0
    ...
    def peek(self):
        """Returnss the element at the head (top) of the calling stack, without removing it.
